...
public class Magazine extends Subsystem{
    ...
    /*public void autoMag() {
        ...
        if (Feedback.magLowCheck.get() && count == 0) {
            count++;
            beltSpeed_high = magSpeed_high;
            if (Feedback.magHighCheck.get()) {
                beltSpeed_high = 0;
                autoMag();
            } else {
                autoMag();
        ...
        if (Feedback.magLowCheck.get() && count == 1) {
            count++;
        ...
        if (Feedback.magLowCheck.get() && count == 2) {
            count++;
            if (Feedback.magLowCheck.get()) {
                beltSpeed_low = 0;
            }
...
/*
                if (highMagFlo == 1 && Feedback.getHighMagPast()) {
                    beltSpeed_high = 0;
                    if (lowMagFlo == 1 && Feedback.getMagLow()) {
                        if (lowMagFlo == 1 && !Feedback.getMagLow()) {
                            beltSpeed_low = 0;
                        }
                    }
