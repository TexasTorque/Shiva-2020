...
public class Feedback { 
    ...
    //mag infared sensors
    public static DigitalInput magHighCheck;
    public static DigitalInput magLowCheck;

    private static DigitalInput magMiddleCheck;
    ...
    private Feedback() {
        ...
        //magMiddleCheck = new DigitalInput(Ports.MAG_SENSOR_MID);
    ...
    public void updateMagazine(){
        ...
        //midMag = !magMiddleCheck.get();

        
            SmartDashboard.putBoolean("lowMagOn", lowMag);
